...
import quebec.virtualite.backend.services.rest.URL_DELETE_CITY_WITHOUT_NAME
...
import quebec.virtualite.backend.services.rest.URL_UPDATE_CITY__POST_WITHOUT_NAME
...
) : RestServerContract
{
    ...
    override fun deleteCity(@PathVariable(required = false) name: String)
    {
        getCity(name)
